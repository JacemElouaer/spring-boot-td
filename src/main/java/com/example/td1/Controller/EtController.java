...
public class EtController {
	...
	{
		return ER.findBynomEContaining('L');
	}
	...
	@GetMapping("/Q5")
	public List<Etudiant> question5()
	{
	...
	@GetMapping("/Q7")
	public Collection<Object> question7()
	{
		return ER.NBDept();
	}

	@GetMapping("/Q8/{x}")
	public List<Departement> question8(@PathVariable Long x)
	{
		return ER.DeptPossedeMinNbEtud(x);
	}
	...
	@GetMapping(path="/Q11/{x}")
	public Collection<Departement> question11(@PathVariable Long x)
	{
		return ER.DeptPossedeMaxNbEtud(x);
	}
	@GetMapping(path="/Q12")
	public List<Departement> question12()
	{
		return ER.DepNexiste();
	}
	
	
	@GetMapping(path="/Q13")
	public List<Object> question13()
	{
		return ER.grandNbEt();
	}
	...
	@GetMapping(path="/Q15")
	public List<Departement> question15()
	{
		return ER.grandNb();
	}
